...
public class Archivo {
    ...
    public int getTam(String contar) {
        int tam = 0;
        char temp;
    ...
    public String convertir(byte[] array){
        String resultado = "";
        char temp;
    ...
    public String getPalabrasClave() {
        return convertir(palabrasClave);
    }
